  ...
  if (!project) {
    return (
      <div className="text-center py-20">
        ...
        <Link to={createPageUrl("Home")} className="text-amber-600 hover:underline mt-4 inline-block text-sm">
          חזרה לדף הבית
        </Link>
      </div>
    );
    ...
    <div className="max-w-4xl mx-auto space-y-4">
      ...
      <div className="eng-card p-5">
        <div className="flex items-start gap-3">
          <Link to={createPageUrl("Projects")} className="text-slate-500 hover:text-amber-600 mt-1 transition-colors">
        ...
        <div className="flex gap-2 mt-4 pt-4 border-t border-slate-200">
          ...
          <Button
            variant="outline"
            className="gap-1.5 border-rose-500/30 text-rose-600 hover:bg-rose-50 h-9 px-3 text-xs font-medium rounded"
